...
echo [%date% %time%] Starting Flask web server in new window...
start "Flask Dashboard" cmd /k "cd /d C:\Users\Alexrs94\Desktop\programfiles\rootrecord\web && python app.py"
timeout /t 5 >nul
